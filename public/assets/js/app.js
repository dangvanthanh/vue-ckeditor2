...
var Ckeditor = {render: function(){with(this){return _h('div',{staticClass:"ckeditor"},[_h('textarea',{attrs:{"id":id,"placeholder":placeholder,"cols":cols,"row":row},domProps:{"value":value}})])}},staticRenderFns: [],
	props: {
		value: {
			type: String
		},
	...
	mounted: function mounted () {
		...
		CKEDITOR.instances[this.id].on('change', function () {
			this$1.$emit('input', CKEDITOR.instances[this$1.id].getData());
		});
	},
	destroyed: function destroyed () {
