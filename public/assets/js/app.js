...
function updateListeners (
  ...
  for (name in on$$1) {
    ...
    if (!cur) {
      ...
      once$$1 = name.charAt(0) === '~'; // Prefixed last, checked first
...
function initEvents (vm) {
  ...
  var add = function (event, fn, once$$1) {
    once$$1 ? vm.$once(event, fn) : vm.$on(event, fn);
  };
...
var Ckeditor = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._c;return _c('div',{staticClass:"ckeditor"},[_c('textarea',{attrs:{"id":_vm.id},domProps:{"value":_vm.value}})])},staticRenderFns: [],
		props: {
      value: {
        type: String
      },
      ...
      CKEDITOR.instances[ckeditorId].on('change', function () {
        ...
        if (ckeditorData !== this$1.value) {
          this$1.$emit('input', ckeditorData);
        }
      });
		},
		destroyed: function destroyed () {
...
var App = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._c;return _c('div',{staticClass:"app"},[_c('ckeditor',{directives:[{name:"model",rawName:"v-model",value:(_vm.content),expression:"content"}],attrs:{"id":"editor","height":'300px',"toolbar":[['Format']]},domProps:{"value":(_vm.content)},on:{"input":function($event){_vm.content=$event;}}}),_c('h2',{staticClass:"heading"},[_vm._v("Raw Html")]),_c('div',{staticClass:"raw",domProps:{"innerHTML":_vm._s(_vm.content)}})])},staticRenderFns: [],
  data: function data () {
    return {
      content: ''
    }
...
var app = new vue_runtime_common$1({
  el: '#app',
