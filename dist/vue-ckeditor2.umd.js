!(function(t, n) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(n)
    : ((t = t || self).VueCkeditor = n());
})(this, function() {
  'use strict';
  var t = new Date().getTime();
  return (function(t, n, e, i, o, s, a, c, r, d) {
      ...
      methods: {
        ...
        update: function(t) {
          this.instanceValue !== t &&
            this.instance.setData(t, { internal: !1 });
        },
        destroy: function() {
          try {
        ...
        onChange: function() {
          ...
          t !== this.value &&
            (this.$emit('input', t), (this.instanceValue = t));
        }
      }
    },
    void 0,
